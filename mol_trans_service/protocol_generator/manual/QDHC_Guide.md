...
With semi-infinite electrode embedding and an electrode-referenced energy scale, L3 captures:
 ...
 - **Mechanisms that depend on electrode-referenced alignment (dominant-channel / interfacial-state attribution near *E_F*)**
...
- **Evidence that L3 is sufficient:**
 ...
 - Identify the dominant transport channel(s) or interfacial-state character near the Fermi level.
