...
## System 1: DPSBF
  ...
  - Core Molecule:
      - abbreviation: DPSBF
      - full_chemical_name: 2,7-di(4-pyridyl)-9,9-spirobifluorene
      - core_smiles: c1ccc2c(c1)-c1ccccc1C21c2cc(-c3ccncc3)ccc2-c2ccc(-c3ccncc3)cc21
  - Anchors:
  ...
  - Interface:
      - interface_geometry_text: Pyridine-N binds to an Au adatom on the Au(111) surface (based on the paper's computational model in Fig. 4b).
  - Variation_notes: "Main molecule (Devices 1 & 2). Has a biphenyl side group, which provides the discrete state."

## System 2: DPFO

  - Core Molecule:
      - abbreviation: DPFO
      - full_chemical_name: 2,7-di(pyridin-4-yl)-fluoren-9-one
      - core_smiles: O=C1c2cc(-c3ccncc3)ccc2-c2ccc(-c3ccncc3)cc21
  - (Anchors, Electrodes, and Interface are the same as System 1)
  - Variation_notes: "Secondary molecule (Device 3). Has a small oxygen side group, which provides a different discrete state."
